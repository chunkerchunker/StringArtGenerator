...
function findWasmBinary() {
  return locateFile("stringart.wasm.wasm");
}
...
var _initStringArt = Module["_initStringArt"] = makeInvalidEarlyAccess("_initStringArt");
...
var _freeOutputImage = Module["_freeOutputImage"] = makeInvalidEarlyAccess("_freeOutputImage");
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = StringArtModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = StringArtModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => StringArtModule);
